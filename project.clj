(defproject journal "0.1.0-SNAPSHOT"

  :description "@mvreri"
  :url "https://somejournal.url"
  ...
  :uberjar-name "journal.jar"
  :repl-options {:init-ns journal.handler}
  :jvm-opts ["-server"]
  :main journal.core
  ...
  :ring {:handler journal.handler/app
         :init    journal.handler/init
         :destroy journal.handler/destroy
         :uberwar-name "journal.war"}
  ...
  {:uberjar {:omit-source true
   ...
   :dev {:dependencies [[ring-mock "0.1.5"]
         ...
         :repl-options {:init-ns journal.repl}
